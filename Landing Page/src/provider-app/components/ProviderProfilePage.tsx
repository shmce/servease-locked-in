...
export function ProviderProfilePage() {
  ...
  const providerName = profile.businessName || "Provider profile";
  const serviceArea = profile.serviceAreas || "Service area not set";
  const yearsExperience = profile.yearsExperience || "Not set";
  const ratingLabel =
    profile.reviewCount > 0 && profile.averageRating > 0
      ? profile.averageRating.toFixed(1)
      : "No rating";
  const availableDays = Object.entries(providerData.availability).filter(
    ([, schedule]) => schedule.available,
  );
  const firstAvailableSchedule = availableDays[0]?.[1];
  const availabilityLabel =
    availableDays.length > 0
      ? availableDays.map(([day]) => day).join(", ")
      : "No active availability";
  const availabilityHours = firstAvailableSchedule
    ? `${firstAvailableSchedule.startTime} - ${firstAvailableSchedule.endTime}`
    : "Not set";
  const badges = [
    {
      icon: profile.verificationStatus === "approved" ? CheckCircle2 : Shield,
      label:
        profile.verificationStatus === "approved"
          ? "Verified"
          : `Verification ${profile.verificationStatus}`,
      color: profile.verificationStatus === "approved" ? "#00BF63" : "#6B7280",
      bg: profile.verificationStatus === "approved" ? "#DCFCE7" : "#F3F4F6",
    },
    ...(profile.averageRating >= 4.5 && profile.reviewCount > 0
              ...
              <div style={{ marginBottom: "12px" }}>
                ...
                <div style={{ display: "flex", alignItems: "center", gap: "16px", marginBottom: "12px" }}>
                  ...
                  <div style={{ display: "flex", alignItems: "center", gap: "6px" }}>
                    ...
                    <span style={{ fontSize: "14px", fontWeight: "600", color: "#111827" }}>{ratingLabel}</span>
      ...
      >
        ...
        >
                ...
                {[1, 2, 3, 4, 5].map((star) => (
                  <Star
                    ...
                    style={{
                      width: "16px",
                      height: "16px",
                      fill: star <= profile.averageRating ? "#F59E0B" : "none",
                      color: "#F59E0B",
                    }}
                  />
                ))}
          ...
          >
            ...
            <p style={{ fontSize: "13px", color: "#6B7280" }}>Customer feedback</p>
          </div>
          ...
          >
            ...
            <p style={{ fontSize: "13px", color: "#6B7280" }}>Listed services</p>
          </div>
          ...
          >
            ...
            <div style={{ display: "flex", alignItems: "center", gap: "8px", marginBottom: "8px" }}>
              ...
              <span style={{ fontSize: "32px", fontWeight: "bold", color: "#111827" }}>
                {providerData.portfolioItems.length}
              </span>
            </div>
            <p style={{ fontSize: "13px", color: "#6B7280" }}>Uploaded items</p>
          </div>
        </div>
              ...
              <div>
                <div style={{ ...styles.card, marginBottom: "24px" }}>
                  ...
                  <p style={{ fontSize: "15px", color: "#374151", lineHeight: "1.7" }}>
                    {profile.bio || "No provider bio added yet."}
                  </p>
                </div>
                      ...
                      {service.reviewCount > 0 && (
                        ...
                        >
                          ...
                          <span style={{ fontSize: "12px", color: "#92400E", fontWeight: "500" }}>
                            {service.averageRating.toFixed(1)} average rating from{" "}
