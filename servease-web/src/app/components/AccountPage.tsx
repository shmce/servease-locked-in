...
import { storeProviderSession } from "@/services/serveaseProviderApi";
...
export function AccountPage() {
  ...
  const loadAccount = async () => {
    ...
    const profileResponse = await getCurrentUserProfile(accessToken)
      .then((data) => ({ data }))
    ...
    if (
      profileResponse.data.user.role === "provider" &&
      profileResponse.data.providerProfile
    ) {
      storeProviderSession(accessToken, profileResponse.data);
