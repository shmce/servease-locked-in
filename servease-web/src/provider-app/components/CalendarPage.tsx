...
const isAvailable = (day: number) => {
  ...
  const handleAddEvent = async () => {
    if (!selectedDateStr) {
      setEventError("Select a date before adding a personal event.");
      return;
    }
  ...
  return (
    <div style={styles.container}>
      <div style={styles.maxWidthContainer}>
        ...
        {(eventFeedback || eventError || availabilityError) && (
          <div
            style={{
              ...styles.card,
              marginBottom: "24px",
              borderColor: eventError || availabilityError ? "#FCA5A5" : "#A7F3D0",
              backgroundColor: eventError || availabilityError ? "#FEF2F2" : "#F0FDF8",
            }}
          >
            <p
              style={{
                fontSize: "14px",
                color: eventError || availabilityError ? "#991B1B" : "#065F46",
                fontWeight: "600",
              }}
            >
              {eventError || availabilityError || eventFeedback}
            </p>
          </div>
        )}
            ...
            >
              ...
              <button
                style={{
                  ...styles.button,
                  ...styles.primaryButton,
                  opacity: isAvailabilityLoading ? 0.7 : 1,
