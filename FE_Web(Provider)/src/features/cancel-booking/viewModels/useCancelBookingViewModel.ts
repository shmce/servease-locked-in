...
interface CancelBookingViewData {
  accessToken: string | null;
}

export function useCancelBookingViewModel(): {
  data: CancelBookingViewData | null;
  isLoading: boolean;
  error: string | null;
} {
  const [data, setData] = useState<CancelBookingViewData | null>(null);
