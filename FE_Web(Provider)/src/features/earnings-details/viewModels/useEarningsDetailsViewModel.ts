...
interface EarningsDetailsViewData {
  accessToken: string | null;
}

export function useEarningsDetailsViewModel(): {
  data: EarningsDetailsViewData | null;
  isLoading: boolean;
  error: string | null;
} {
  const [data, setData] = useState<EarningsDetailsViewData | null>(null);
