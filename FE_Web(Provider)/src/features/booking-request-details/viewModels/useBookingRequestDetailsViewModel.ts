...
interface BookingRequestDetailsViewData {
  accessToken: string | null;
}

export function useBookingRequestDetailsViewModel(): {
  data: BookingRequestDetailsViewData | null;
  isLoading: boolean;
  error: string | null;
} {
  const [data, setData] = useState<BookingRequestDetailsViewData | null>(null);
