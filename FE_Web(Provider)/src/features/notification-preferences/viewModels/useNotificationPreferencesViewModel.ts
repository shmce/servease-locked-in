...
interface NotificationPreferencesViewData {
  accessToken: string | null;
}

export function useNotificationPreferencesViewModel(): {
  data: NotificationPreferencesViewData | null;
  isLoading: boolean;
  error: string | null;
} {
  const [data, setData] = useState<NotificationPreferencesViewData | null>(null);
