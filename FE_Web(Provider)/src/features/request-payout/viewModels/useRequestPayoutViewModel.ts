...
interface RequestPayoutViewData {
  accessToken: string | null;
}

export function useRequestPayoutViewModel(): {
  data: RequestPayoutViewData | null;
  isLoading: boolean;
  error: string | null;
} {
  const [data, setData] = useState<RequestPayoutViewData | null>(null);
