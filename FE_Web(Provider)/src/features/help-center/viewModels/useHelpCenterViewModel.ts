...
interface HelpCenterViewData {
  accessToken: string | null;
}

export function useHelpCenterViewModel(): {
  data: HelpCenterViewData | null;
  isLoading: boolean;
  error: string | null;
} {
  const [data, setData] = useState<HelpCenterViewData | null>(null);
