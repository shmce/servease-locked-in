          ...
          >
            <div className="flex items-center gap-[14px] p-[18px]">
              ...
              <div className="flex-1">
                <h3 className="font-semibold text-[16px] text-[#1a1a1a] mb-[2px]">
                  Customer
                </h3>
                <p className="text-[13px] text-[#666] leading-[1.3]">
        ...
        <div className="text-center mt-[32px]">
          <p className="text-[14px] text-[#6B7280]">
            ...
            <button
              ...
              className="text-[#56C490] font-semibold text-[14px] transition-all active:opacity-70"
            >
              Sign Up
            </button>
          </p>
