...
// ─── Component ─────────────────────────────────────────────────
export default function ProviderSetupProfile() {
  ...
  const canContinue = isBusinessNameValid && isFullNameValid && isMobileValid;

  const handleContinue = () => {
    // Navigate to Add Payout Method (Step 2 of provider onboarding)
    navigate("/provider/add-payout-method");
  };
  ...
  return (
    <div className="bg-white w-full h-screen flex flex-col">
      ...
      <div className="px-[24px] pt-[8px] pb-[20px] flex-shrink-0">
        ...
        {/* Progress Bar – 5 segments for provider onboarding */}
      ...
      >
        ...
        <p className="font-['Nunito',sans-serif] text-[15px] text-[#6B7280] leading-[1.5] mb-[28px]">
          This helps customers know who they're hiring and builds trust in your services.
        </p>
      ...
      {/* ── Sticky Bottom CTA ── */}
      <StickyFooterButton
        label="Continue to Payout Method"
