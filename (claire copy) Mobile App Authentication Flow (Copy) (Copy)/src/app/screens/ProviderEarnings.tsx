...
export default function ProviderEarnings() {
  ...
  const serviceCategoryData = [
    { name: "House Cleaning", value: 4500, color: "#56C490" },
    ...
    <div className="bg-[#F9FAFB] w-full h-screen flex flex-col">
      ...
      <div className="mt-[106px] mb-[34px] overflow-y-scroll">
        ...
        <div className="px-[24px] pb-[20px] bg-white border-b border-[#E5E7EB]">
          <div className="text-center py-[8px]">
            ...
            <div className="flex items-center justify-center gap-[8px]">
              <h2 className="font-bold text-[42px] text-[#56C490] tracking-tight">
                ₱{totalEarnings.toLocaleString()}
              </h2>
              <div className="flex items-center gap-[4px] px-[8px] py-[4px] bg-[#56C490]/10 rounded-[8px]">
                <TrendingUp className="w-[14px] h-[14px] text-[#56C490]" />
                <span className="text-[12px] font-semibold text-[#56C490]">+12%</span>
              </div>
            </div>
          </div>
        </div>
          ...
          <div className="grid grid-cols-3 gap-[8px]">
            ...
            <div className="bg-white rounded-[12px] p-[12px] border border-[#E5E7EB]">
              <div className="w-[32px] h-[32px] rounded-[8px] bg-[#D1FAE5] flex items-center justify-center mb-[8px]">
                <CheckCircle className="w-[16px] h-[16px] text-[#56C490]" />
              </div>
        ...
        <div className="px-[24px] pb-[20px] bg-[#F9FAFB]">
          <div className="grid grid-cols-2 gap-[12px]">
            <button 
              ...
              className="bg-[#56C490] py-[14px] rounded-[12px] flex items-center justify-center gap-[8px] shadow-[0_2px_8px_rgba(86,196,144,0.25)] transition-all active:scale-95"
            >
        ...
        <div className="px-[24px] pt-[20px] pb-[24px] bg-[#F9FAFB]">
            ...
            {topEarningDays.map((item, index) => (
              <div key={item.day}>
                <div className="flex items-center justify-between mb-[6px]">
                  ...
                  <span className="text-[11px] font-medium text-[#56C490]">{item.percentage}%</span>
                </div>
                <div className="w-full h-[6px] bg-[#F3F4F6] rounded-full overflow-hidden">
                  <div 
                    className="h-full bg-gradient-to-r from-[#56C490] to-[#059669] rounded-full transition-all"
          ...
          {/* Efficiency Tip */}
          <div className="mt-[12px] bg-[#E8F5E9] border border-[#56C490]/20 rounded-[12px] p-[14px]">
            <div className="flex gap-[10px]">
              <div className="w-[36px] h-[36px] rounded-[8px] bg-[#56C490]/10 flex items-center justify-center flex-shrink-0">
                <TrendingUp className="w-[18px] h-[18px] text-[#56C490]" />
              </div>
              <div>
                <p className="font-semibold text-[13px] text-[#111827] mb-[4px]">Efficiency Tip</p>
                <p className="text-[12px] text-[#374151] leading-[1.5]">
                  Your peak earning hours are <span className="font-semibold text-[#56C490]">10 AM - 2 PM on weekdays</span>. 
