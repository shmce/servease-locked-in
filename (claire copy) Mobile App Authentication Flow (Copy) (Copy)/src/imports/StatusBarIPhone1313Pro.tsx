import svgPaths from "./svg-cfa4vm9xng";
...
export default function StatusBarIPhone1313Pro() {
  return (
    <div className="relative size-full" data-name="Status Bar / iPhone 13 & 13 Pro">
